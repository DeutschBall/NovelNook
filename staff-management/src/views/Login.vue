    ...
    <div v-loading="loading" element-loading-text="登录中..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.6)" class="login-container">
      ...
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
        ...
        <div class="title-container">
          <h3 class="title">Administrator Back-end System</h3>
        </div>
        ...
        <div>
          <el-button type="primary" style="width:100%;margin-bottom:20px;" @click.native.prevent="handleLogin">Log in</el-button>

        </div>
        <div class="tips">
          <span style="margin-right:20px;">If you do not have an account,please <span style="color:#409EFF;cursor:pointer" @click="register">Register</span></span>
        </div>
